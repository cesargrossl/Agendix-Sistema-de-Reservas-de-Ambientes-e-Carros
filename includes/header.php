<?php
  ...
  $qry_teste = $db->select("SELECT * FROM tb_usuarios ", "portal");
  if (count($qry_teste)) {
      $nomes= array();
      foreach ($qry_teste as $conta_teste=>$res_teste) {
          echo  utf8_encode($res_teste["teste"]); echo '<br>';
      }
  }
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Agendix</span></a>
            </div>
